...
public class UACSettingFieldConstants {
	...
	public static final String[] TERMINAL_TYPE = { "Microphone", "Speaker" };
	...
	public static List<String> SAMPLING_FREQUENCIES1_LIST = new ArrayList<String>(
			Arrays.asList(SAMPLING_FREQUENCIES));

	public static List<String> SAMPLING_FREQUENCIES2_LIST = new ArrayList<String>(
			Arrays.asList(SAMPLING_FREQUENCIES));

	public static List<String> SAMPLING_FREQUENCIES3_LIST = new ArrayList<String>(
			Arrays.asList(SAMPLING_FREQUENCIES));

	public static List<String> SAMPLING_FREQUENCIES4_LIST = new ArrayList<String>(
			Arrays.asList(SAMPLING_FREQUENCIES));
