...
public class SX3CommonUIValidations {
	...
	public static void showErrorRichText(TextField vendorId, final ContextMenu contextRichText, String message) {
	...
	public static boolean isValidHex1(String hexVal) {
		try {
			// valid hex
			Long.parseLong(hexVal, 16);
			return true;
		} catch (NumberFormatException nfe) {
			// not a valid hex
		}
