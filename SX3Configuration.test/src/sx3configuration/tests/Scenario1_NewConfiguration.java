...
public class Scenario1_NewConfiguration extends TestFXBase {
	...
	@Test
	public void test1_scenario_NewConfiguration_Export() throws InterruptedException {
		...
		saveConfiguration();sleep(3000);
		exportAction(); sleep(2000);
	...
	private void exportAction() {
		...
		clickOn("#exportConfigurationOkBtn");sleep(6000);
	}
